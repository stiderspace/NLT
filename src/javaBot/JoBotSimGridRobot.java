...
public class JoBotSimGridRobot extends NanoRobot {
	...
	private static final String CONFIG_XML = Simulator
			.getRelativePath("./SimPro/Grid/joBotNano.xml");
	 ...
	 */
	public JoBotSimGridRobot(String name, double positionX, double positionY) {
		/*

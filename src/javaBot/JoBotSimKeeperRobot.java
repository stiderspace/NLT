...
public class JoBotSimKeeperRobot extends NanoRobot {
	...
	private static final String CONFIG_XML = Simulator
			.getRelativePath("./SimPro/Keeper/joBotNano.xml");
	 ...
	 */
	public JoBotSimKeeperRobot(String name, double positionX, double positionY) {
		/*

...
public class SensorUvmImpl implements ISensorUvm {
	...
	public SensorUvmImpl(int sensorId, String simulatorProxy,
			String simulatorPort, String simulatorIp) {

		mySimulatorProxy = new ISensorUvmProxy(simulatorProxy + ":"
				+ simulatorPort + "/http://" + simulatorIp);
		mySensorId = sensorId;
	}

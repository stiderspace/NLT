...
public class ISensorUvmProxy extends HttpGetClientProtocol implements
		ISensorUvm {
	String myIPAddress;
	...
	public byte[] getSample(int sensor) {
		return invokeByteArray(myIPAddress, "//getSample",
				new Object[] { new Integer(sensor) });
	}

	public int getSensorValue(int sensor) {
		return invokeInt(myIPAddress, "//getSensorValue",
				new Object[] { new Integer(sensor) });
	}

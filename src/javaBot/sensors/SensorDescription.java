...
public class SensorDescription {
	 ...
	 *            TODO PARAM: DOCUMENT ME!
	 */
	SensorDescription(int id, String gatewayIp, String gatewayPort,
			String deviceIp, String serviceInterface, String serviceType) {
		myId = id;
	...
	public boolean matchGateway(String gatewayIp, String gatewayPort) {
		return gatewayIp.equals(myGatewayIp)
				&& gatewayPort.equals(myGatewayPort);
	}
	 ...
	 * @return $returnType$ TODO RETURN: return description
	 */
	public Object createService(String simulatorProxy, String simulatorPort,
			String simulatorIp) {
		switch (myServiceInterface) {
		case INTERFACE_SIM_SENSOR:
			return new SensorSimImpl(myId, simulatorProxy, simulatorPort,
					simulatorIp);

		case INTERFACE_UVM_SENSOR:
			return new SensorUvmImpl(myId, simulatorProxy, simulatorPort,
					simulatorIp);
		}

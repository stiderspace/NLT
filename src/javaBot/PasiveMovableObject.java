...
public abstract class PasiveMovableObject extends MovableObject {
	 ...
	 *            how big is it
	 * @param mass
	 *            how heavy is it Speed, rotation and acceleration are put to
	 *            zero by default
	 */
	public PasiveMovableObject(String name, double friction, double positionX,
	...
	public void update(double elapsed) {
		 ...
		 * sampling
		 */
		this.setVelocityX((Math.abs(this.getVelocityX()) > Math.abs(dvx)) ? (this
				.getVelocityX() + dvx) : 0.0);
		this.setVelocityY((Math.abs(this.getVelocityY()) > Math.abs(dvy)) ? (this

...
public class NXTRescueRobot extends NanoRobot
{
	private static final String	IMAGE_FILE			= Simulator
															.getRelativePath("./resources/nxtr.gif");
	private static final String	CONFIG_XML			= Simulator
															.getRelativePath("./NXT/Rescue/joBotNano.xml");
	 ...
	 * @param positionY
	 */
	public NXTRescueRobot(String name, double positionX, double positionY)
	{
		/*
		 * friction = 7.0
		 * diameter = 2.0

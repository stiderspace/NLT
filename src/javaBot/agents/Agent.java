 ...
 */
/**
 * @version $Revision: 1.1 $ last changed Mar 6, 2006
 * 
 */
public abstract class Agent extends Thread {
	 ...
	 * (robot == null) <br>
	 * [JD] setting robot=null leads to nullpexceptions in agent thread so don't
	 * do it. Setting running=false will kill the thread anyway. But each agent
	 * should of course check the running field.
	 */
	public void kill() {

...
/**
 * The reflection sensor is a kind of distancesensor
 */
public class ReflectionSensor extends DistanceSensor {
	 ...
	 * @param angle
	 *            The angle where the sensor is pointing at
	 */
	...
	/**
	 * Comment: From 0 - 8 CM the measuring is imprecise. <br>
	 * [jd] TODO: values >506 will now return 7 instead of divide by zero
	 * except. Is that correct?
	 * 
	 * @param value
	 * @return
	 */
	...
	/**
	 * Convert a (real) sensor value to a distance reading in meters
	 */

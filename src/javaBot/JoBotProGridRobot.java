...
public class JoBotProGridRobot extends NanoRobot {
	...
	private static final String CONFIG_XML = Simulator
			.getRelativePath("./JoBotPro/Grid/joBotNano.xml");
	 ...
	 */
	public JoBotProGridRobot(String name, double positionX, double positionY) {
		/*

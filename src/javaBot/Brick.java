...
public class Brick extends NonMovableObject implements IDragable {
	 ...
	 * 
	 * @param r
	 *            Robot who want to have the information
	...
	/**
	 * @param startPosition
	 *            Location with startposition on the center of the object
	 * @param dRealRotation
	 *            Rotation of object in Radialen
	 * @return
	 */
	...
	/**
	 * @return current height of brick Have to resize the dimensions, but is not
	 *         clear why.
	 */
	...
	/**
	 * Function for setting the rotation of the wall Needed because the wall has
	 * to be recalculated
	 * 
	 * @param rotation
	 *            Rotation of wall
	 ...
	 * 
	 * @param object
	 *            The object the collision will be calculated
	 */

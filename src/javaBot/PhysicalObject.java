...
/**
 * Abstract class that should be extended by every object in the simulation that
 * should have any physical properties.
 */
public abstract class PhysicalObject {
	...
	public double orientation = 0; // Mainly used for compass heading
	 ...
	 * 
	 * @param r
	 *            The robot whose sensors you want to calculate the sensor
	 *            values of
	 * 
	 ...
	 * prevents the GraphicalRepresentation object being created at every frame
	 * 
	 ...
	 *            Rotation set for the object
	 */
	public void setOrientation(double rotation) {

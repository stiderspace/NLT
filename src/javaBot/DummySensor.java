...
/**
 * Dummy Sensor: included to allow additional sensors For future reference only
 */
public class DummySensor extends Sensor {
	...
	protected static int getValue(int distance) {
		...
		// Debug.printInfo("ContactSensor getValue for distance="+distance +
		// " =" + i);
		return i;
	}
	...
	public int convertDistanceToValue(double dist) {
		int i = 0;
		// Debug.printInfo("ContactSensor.convertDistanceToValue for dist ="+
		// dist);

...
public class GraphPlot extends JPanel {
	...
	/**
	 * Will calculate the maximum Y value which can be used to set the scale of
	 * the graph. (Highest peak will reach top of graph)
	 */
	 ...
	 * 
	 * @param g
	 *            Grahics object used for painting
	 */
